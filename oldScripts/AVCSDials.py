...
class AVCSProgressBar(Widget):
    ...
    def __init__(self, **kwargs):
        super(AVCSProgressBar, self).__init__(**kwargs)
...
#            raise TypeError("Progress must be an integer value, not {}!".format(type(value)))
    ...
    def _refresh_text(self):
        ...
        """
        self._text_label.text = self._default_label_text.format(str((self.get_normalised_progress())))
    ...
    def get_normalised_progress(self) -> float:
        ...
        :return: Current progress normalised to match the percentage constants
        """
        value = _NORMALISED_MIN + (self._value - self._min_progress) * (_NORMALISED_MAX - _NORMALISED_MIN) \
    ...
    def set_normalised_progress(self, norm_progress: float):
        ...
        if _NORMALISED_MIN > norm_progress or norm_progress > _NORMALISED_MAX:
    ...
    def _draw(self):
        ...
        with self.canvas:
            ...
            Line(circle=(self.pos[0] + self._widget_size / 2, self.pos[1] + self._widget_size / 2,
                         self._widget_size / 2 - self._thickness, 0, self.get_normalised_progress() * 180),
